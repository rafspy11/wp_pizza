	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			<a href="/" class="custom-logo-link" rel="home">
				<svg id="logo" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 52.39"> 
			...
			$pizza_description = get_bloginfo( 'description', 'display' );
			if ( $pizza_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $pizza_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->

		<nav id="site-navigation" class="main-navigation">
			<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'pizza' ); ?></button>
			<?php
			wp_nav_menu(
				array(
